...
const LayoutEditorOverlay: React.FC<Props> = ({ config, onUpdate, onClose, t }) => {
  return (
    <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-none flex flex-col items-center justify-center p-8 animate-fade-in">
       ...
       <div className="text-center mb-12">
           <h1 className="text-4xl font-black text-white drop-shadow-lg flex items-center justify-center gap-4">
              <LayoutGrid className="w-10 h-10" /> {t('layout_editor')}
           </h1>
           <p className="text-white/60 mt-4 text-xl">{t('layout_editor_subtitle')}</p>
       </div>
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-4xl">
           ...
           <div className="bg-[var(--card-bg)] border border-[var(--glass-border)] rounded-3xl p-8 shadow-2xl flex flex-col items-center relative overflow-hidden">
               <h3 className="text-xl font-bold text-[var(--text-main)] mb-6">{t('sidebar_panel')}</h3>
               ...
               <div className="flex gap-4">
                   ...
                   >
                     <ArrowLeft className="w-6 h-6" /> {t('dock_left')}
                   </button>
                   <button 
                   ...
                   >
                     <ArrowRight className="w-6 h-6" /> {t('dock_right')}
                   </button>
               </div>
           </div>
           ...
           <div className="bg-[var(--card-bg)] border border-[var(--glass-border)] rounded-3xl p-8 shadow-2xl flex flex-col items-center relative overflow-hidden">
               <h3 className="text-xl font-bold text-[var(--text-main)] mb-6">{t('player_dock')}</h3>
               ...
               <div className="grid grid-cols-2 gap-4">
                   ...
                   >
                     <ArrowUp className="w-6 h-6" /> {t('dock_top')}
                   </button>
                   <button 
                   ...
                   >
                     <ArrowDown className="w-6 h-6" /> {t('dock_bottom')}
                   </button>
                   <button 
